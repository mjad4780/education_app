...
import '../../chats/widget/chat_bubble.dart';

class ScreenChatMentors extends StatefulWidget {
  const ScreenChatMentors({super.key, required this.mentorId});
  final int mentorId;

  @override
  State<ScreenChatMentors> createState() => _ScreenChatMentorsState();
}

class _ScreenChatMentorsState extends State<ScreenChatMentors> {
